...
const TYPE_NUMBERS: Array[int] = [1, 2, 3]
...
static var TYPE_INFOS: Array[StudentTypeInfo] = [	
	...
	StudentTypeInfo.new(Type.INF, 3, "res://assets/student_icons/inf_04.png", TYPE_COLORS[0]),
	...
	StudentTypeInfo.new(Type.MATH, 3, "res://assets/student_icons/kma_calculus.png", TYPE_COLORS[1]),
...
#	StudentTypeInfo.new(Type.MATH, 5, "res://icon.svg", TYPE_COLORS[1]),
	...
	StudentTypeInfo.new(Type.GEO, 1, "res://assets/student_icons/kgm_geodet.png", TYPE_COLORS[2]),
...
#	StudentTypeInfo.new(Type.GEO, 6, "res://icon.svg", TYPE_COLORS[2]),
	...
	StudentTypeInfo.new(Type.MECH, 1, "res://assets/student_icons/kme_materials.png", TYPE_COLORS[3]),
